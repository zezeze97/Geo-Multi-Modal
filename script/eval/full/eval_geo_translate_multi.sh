...
N=8
base_answer_path='./outputs/bunny-yi1.5-9B-Chat-FormalGeoCoT-VisionPretrained-sft1e-v7/test_geoqa_translate'
...
do
    ...
    CUDA_VISIBLE_DEVICES="${gpus[chunk_id]}" python bunny/eval/model_vqa.py --model-type yi1.5 \
                                                                     --model-path checkpoints/checkpoints-yi1.5/bunny-yi1.5-9B-Chat-FormalGeoCoT-VisionPretrained-sft1e-v7 \
                                                                     --vision_encoder_path checkpoints/checkpoints-yi1.5/bunny-yi1.5-9B-Chat-FormalGeoCoT-VisionPretrained-sft1e-v7 \
