...
N=6
base_answer_path="./outputs/report/bunny-yi1.5-9B-Chat-FormalGeoCoT-VisionPretrained-sft2e-v12/${question_file}_${qa_mode}_withoutDiagram"
gpus=(2, 3, 4, 5, 6, 7)  # Define the GPU IDs array
