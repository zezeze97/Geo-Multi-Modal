...
N=4
base_answer_path='./outputs/report/bunny-yi1.5-9B-Chat-FormalGeoCoT-VisionPretrained-sft1e-v18/test_geoqa_translate'
...
do
    ...
    CUDA_VISIBLE_DEVICES="${gpus[chunk_id]}" python bunny/eval/model_vqa.py --model-type yi1.5 \
                                                                     --model-path checkpoints/checkpoints-yi1.5/bunny-yi1.5-9B-Chat-FormalGeoCoT-VisionPretrained-sft1e-v18 \
                                                                     --vision_encoder_path checkpoints/checkpoints-yi1.5/bunny-yi1.5-9B-Chat-FormalGeoCoT-VisionPretrained-sft1e-v18 \
                                                                     --question-file data_backup/formalgeo7k/formalgeo7k_v2/custom_json/qa_translate/formalgeo_test_geoqa_translate_qs.jsonl \
