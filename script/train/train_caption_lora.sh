...
MODEL_TYPE=yi1.5
OUTPUT_DIR=bunny-lora-$MODEL_TYPE-qa-FormalGeoV2Aug10Times_calibrate_v1v2_structure_only-sft1
...
deepspeed --include=localhost:0,1,2,3,4,5,6,7 --master_port 25680 bunny/train/train.py \
    ...
    --version qwen-chat \
    --data_path data/formalgeo7k/formalgeo7k_v2/custom_json/qa_structure_only/qa_structure_only_train_aug10times_calibrate_mixV1V2.json \
    --image_folder data \
    --customized_aug True \
