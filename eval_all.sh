...
sh script/eval/full/eval_geo_multi_cascade.sh formalgeo_test_geoqa_qs_meta Q+PredCDL2Ans > cascade_q_and_Predcdl2ans.log 2>&1 
sh script/eval/full/eval_geo_multi_cascade.sh formalgeo_test_geoqa_qs_meta_choice Q+PredCDL2Ans > cascade_q_and_Predcdl2ans_choice.log 2>&1 
sh script/eval/full/eval_geo_multi_cascade.sh formalgeo_test_geoqa_qs_meta Q+PredCDL2CalibrateCDLandAns > cascade_q_and_Predcdl2cdl_and_ans.log 2>&1
sh script/eval/full/eval_geo_multi_cascade.sh formalgeo_test_geoqa_qs_meta_choice Q+PredCDL2CalibrateCDLandAns > cascade_q_and_Predcdl2cdl_and_ans_choice.log 2>&1
sh zk.sh