...
class DPOTrainer(Trainer):
    ...
    def concatenated_inputs(
        ...
        origin_images = batch['images']
        concatenated_batch['images'] = origin_images.repeat(2, 1, 1, 1)
    ...
    def get_batch_logps(
        ...
        # print(f'per_token_logps shape is {per_token_logps.shape}')
    ...
    def concatenated_forward(
        ...
        # print(f'len_chosen is {len_chosen}')
        model_kwargs = (
            {
        ...
        # temp = concatenated_batch['concatenated_labels']
        # print(f'origin label shape is {temp.shape}')
        all_logits, modified_labels = model(
        ...
        # print(f'all_logps shape is {all_logps.shape}')
