...
class ModelWorker:
    def __init__(self, controller_addr, worker_addr,
                 ...
                 model_path, model_base, model_name, model_type, vision_encoder_path,
                 load_8bit, load_4bit, device, crop_image):
        ...
        self.tokenizer, self.model, self.image_processor, self.context_len = load_pretrained_model(
            model_path, model_base, self.model_name, model_type, load_8bit, load_4bit, device=self.device, vision_encoder_path=vision_encoder_path)
    ...
    def generate_stream(self, params):
        ...
        if images is not None and len(images) > 0 and self.is_multimodal:
            if len(images) > 0:
                ...
                images = process_images(images, image_processor, model.config, crop_image=self.crop_image)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--vision-encoder-path", type=str, default=None)
